...
<li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Area Chuygklujhart -->
       Welcome <?php echo $take['firstname']; ?>. Manage your application. Know about other users
            <!-- Pie Chart -->
         ...
         <ul class="userinfo">
	 <?php 
	 $first = mysqli_query($connection,"SELECT * FROM chat");
	 while($row = mysqli_fetch_assoc($first)){?>
		 <li><a kanor="<?php echo $row['id']; ?>" class="banor btn btn-primary" style="display:block;margin-top:20px;" href="#"><?php echo $row['firstname'].' '.$row['lastname']; ?></a></li>
	 <?php }
	 ?>
	 </ul>
	 <div class="nanua" style="display:none"></div>
