...
if(isset($_POST['submit'])){
	...
	$target = 'images/'.basename($_FILES['file']['name']);
	$image = $_FILES['file']['name'];
	$query = mysqli_query($connection,"INSERT INTO file (senderemail,senderfile,receiveremail) VALUES ('$jina','$image','$murgi3')");
...
<li class="nav-item dropdown no-arrow mx-1">
	   ...
	   Files that you have got from other users. Download the files and enjoy
            <!-- Pie Chart -->
            
          </div>
<?php 
$let = mysqli_query($connection,"SELECT * FROM file WHERE receiveremail = '$put2'");
while($jinish = mysqli_fetch_assoc($let)){?>
	<div class="card" style="width: 25rem; height:200px; text-align:center;margin-left: 33%;
margin-top: 20px;">
<?php 
...
<?php }
	...
	<a href="images/<?php echo $jinish['senderfile']; ?>" title="click to download" download>
...
?>
  ...
  <div class="card-body">
    <h5 class="card-title btn btn-primary">Sent by <?php echo $jinish['senderemail']?></h5>
