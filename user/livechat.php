      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item" href="sent.php">Received files</a>
...
<li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Area Chuygklujhart -->
       Welcome <?php echo $take['firstname']; ?>. Manage your application. Have a private chat.
            <!-- Pie Chart -->
            
          </div>

         <ul class="livemessagesend">
	 <?php 
	 ...
	 while($row = mysqli_fetch_assoc($first)){?>
		 <li><a zakor="<?php echo $row['lastname']; ?>" yanor="<?php echo $row['firstname']; ?>" class="uanor btn btn-primary" style="display:block" href="chatpage.php"><?php echo $row['firstname'].' '.$row['lastname']; ?></a></li>
	 <?php }
	 ?>
	 </ul>
