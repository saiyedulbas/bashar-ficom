...
<li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Area Chuygklujhart -->
       Welcome <?php echo $take['firstname']; ?>. Manage your application. Here is your inbox.
            <!-- Pie Chart -->
    ...
    <?php 
	 $first = $_SESSION['firstname'];
	   ...
	   while($row = mysqli_fetch_assoc($query)){?>
		   <div class="card-body inboxinfo">
		   <?php echo '<p class="btn btn-primary">'.$row['senderfirstname'].' '.$row['senderlastname'].' : '.$row['message'].'</p>'; ?>
		   <?php echo '<p class="btn btn-success">'.$row['created_at'].'</p>'; ?>
		   </div>
