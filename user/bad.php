...
<body>
	...
	if(isset($_POST['jago'])){
		...
		$query = mysqli_query($connection,"UPDATE chat SET usercomment = 'bad user',
        markinguser = '$second', usernotification = '5' WHERE firstname = '$take'");
...
<!-- START SHOWCASE -->
	...
	'.$second.' HAS SENT THIS reprot TO YOU.
		</td>
		</tr>
		...
		<tr align="center">
		<td style="font-family: Lato, sans-serif; width:100%; font-size:14px; color:#757575; line-height:24px; font-weight: 300;">you have been marked as bad user by '.$second.'</td>
		</tr>
