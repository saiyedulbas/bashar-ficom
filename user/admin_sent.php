...
<?php 
$let = mysqli_query($connection,"SELECT * FROM admincontact WHERE senderfirstname = '$put2'");?>
<div class="card" style="width: 895px; text-align:center;margin-left: 14%;
margin-top: 20px;">
<?php 
while($jinish = mysqli_fetch_assoc($let)){?>
  ...
  <div class="card-body">
    <p style="display:inline; margin-right:20px;" class="btn btn-primary"><?php echo $jinish['message']?></p><p style="display:inline" class="btn btn-success"><?php echo $jinish['created_at']?></p>
