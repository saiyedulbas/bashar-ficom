...
<li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Area Chuygklujhart -->
       Welcome <?php echo $take['firstname']; ?>. Manage your application.
            <!-- Pie Chart -->
            
          </div>
		  <br />
		  
<a href="https://findbashar.com/" target="_blank" class="btn btn-success">Visit Bashar's Portfolio first</a>
         <div class="card" style="width: 18rem; text-align:center;margin-left: 33%;
margin-top: 20px;">
  <img class="card-img-top" src="../images/<?php echo $take['photo']; ?>" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title"><?php echo $take['firstname']." ".$take['lastname'] ?></h5>
    <p class="card-text"><?php echo $take['email'] ?></p>
    <p class="card-text"><?php echo $take['date'] ?></p>
    <p class="card-text"><?php echo $take['token'] ?></p>
  </div>
	...
	<img style="width:200px;height:200px;border-radius:50%" src="../images/<?php echo $take['photo']; ?>" />
	<br>
	<p class="btn btn-primary" style="width:30%;

margin-top: 10%;">Welcome to your homepage, <?php echo $take['firstname']; ?></p>
</div>
	</div>    
