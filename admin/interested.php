...
if($take['status'] == 1){?>
	 ...
	 <input type="search" class="form-control" id="real" />
	 <a class="dish btn btn-primary" style="float:right;" href="#">Unapproved People</a>
	 </form>
          <?php 
  ...
  <?php 
	 ...
	 <div class="last" style="display:none" >
		   <p class="dekhi btn btn-primary">do you want to execute this?</p>
		   </div>
	 ...
	 <div class="ultra" style="display:none">
	       <p class="dekhi btn btn-primary" >Do you really want to do it?</p>
	 </div>
