      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="registered_people.php">Interested People</a>
            <a class="collapse-item" href="reported_user.php">Reported User</a>
...
<button style="margin-left:20px" class="btn btn-danger">For any query, just contact Bashar at 01834663387 or see the documentation & site tour</button>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="pagetitle" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $jhata['pagetitle']; ?>" placeholder="" required>
    
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">pagecontent</label>
    <textarea name="pagecontent" id="pagecontent" class="form-control" placeholder="content" cols="30" rows="10"><?php echo $jhata['pagecontent']; ?></textarea>
  </div>
  ...
  <button type="submit" name="addpage" class="btn btn-primary popsubmit">Submit</button>
</form>
       <?php 
	 if(isset($success)){
		 echo $success;
