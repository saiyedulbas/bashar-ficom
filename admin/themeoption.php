...
$put = $_SESSION['email'];
	...
	$query = mysqli_query($connection,"UPDATE theme SET slogan = '$slogan', copyright = '$copyright', title = '$title'");
	$chor = mysqli_query($connection,"UPDATE  image SET image='$image' WHERE id = 3");
...
<button style="margin-left:20px" class="btn btn-danger">For any query, just contact Bashar at 01834663387 or see the documentation & site tour</button>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="title" id="exampleInputEmail1" aria-describedby="emailHelp" value = "<?php echo $luna['title']; ?>" placeholder="" required>
    
  </div>
  <div class="form-group">
    <label for="exampleInputPassword2">Type Your Slogan</label>
    <input type="text" class="form-control" name="slogan" id="exampleInputPassword2" aria-describedby="emailHelp" value = "<?php echo $luna['slogan']; ?>" placeholder="" required>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword3">Type Your Sub Slogan</label>
    <input type="text" class="form-control" name="copyright" id="exampleInputPassword3" aria-describedby="emailHelp" value="<?php echo $luna['copyright']; ?>" placeholder="" required>
  </div>
  <p for="slogan">Current Homepage Background Image:<?php echo $narc['image']; ?></p>
  <div class="form-group">
    <label for="exampleInputPassword4">Select a photo</label>
    <input type="file" class="form-control" name="file" id="exampleInputPassword4" aria-describedby="emailHelp" placeholder="" required>
  </div>
